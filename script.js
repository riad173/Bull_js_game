window.addEventListener('load', function(){
    ...
    class Egg {
        ...
        update(deltaTime){
            ...
            let collisionObject = [this.game.player, ...this.game.obstacle, ...this.game.enemise, ...this.game.hatchlings];
    ...
    class Larva {
        ...
        update(){
            ...
            this.game.enemise.forEach(enemy => {
    ...
    class Game {
        ...
        render(context, deltaTime){
            if(this.timer > this.interval){
                ...
                this.gameObjects = [this.player, ...this.eggs, ...this.obstacle, ...this.enemise, ...this.hatchlings, ...this.particles];
            ...
            if(this.score >= this.winningScore){
                ...
                if(this.lostHatchlings <= 5){
                    ...
                    // lose
                    message1 = 'Bullocks!';
                    message2 = 'You lost ' + this.lostHatchlings + " hatchlings, don't a pushover!";
                }
        ...
        addEnemy(){
            this.enemise.push(new Enemy(this));
        }
